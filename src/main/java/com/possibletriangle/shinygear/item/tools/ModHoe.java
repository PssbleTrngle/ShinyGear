...
public class ModHoe extends ItemHoe implements IModItem {

	private static final String tool = "hoe";
	...
	public ModHoe(String prefix, ToolMaterial material, String oreMaterial) {
		super(material);
	...
	public void recipe() {
		...
		new RecipeHandler.ShapedRecipe(new ItemStack(this), new Object[] { "xx", " y", " y", 'x', oreMaterial, 'y',
