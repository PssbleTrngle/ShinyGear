...
public class ModSpear extends ItemSpear implements IModItem {

	private static final String tool = "spear";
	...
	public ModSpear(String prefix, ToolMaterial material, String oreMaterial) {
