...
public class ModSword extends ItemSword implements IModItem {

	private static final String tool = "sword";
	...
	public ModSword(String prefix, ToolMaterial material, String oreMaterial) {
		super(material);
	...
	public void recipe() {
		...
		new RecipeHandler.ShapedRecipe(new ItemStack(this), new Object[] { " x ", " x ", " y ", 'x', oreMaterial, 'y',
