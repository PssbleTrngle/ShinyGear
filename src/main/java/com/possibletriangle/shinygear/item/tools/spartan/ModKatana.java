...
public class ModKatana extends ItemKatana implements IModItem {

	private static final String tool = "katana";
	...
	public ModKatana(String prefix, ToolMaterial mat, String oreMaterial) {
		super( prefix + "_" + tool, ShinyGear.MODID, IModSpartanItem.fromMaterial(mat, oreMaterial), IModSpartanItem.getDamage(5, mat));
	...
	public void recipe() {
		new RecipeHandler.ShapedRecipe(new ItemStack(this, 1),
				new Object[] { "  x", " x ", "y  ", 'x', oreMaterial, 'y', new ItemStack(ItemRegistrySW.material, 1, 0) });
	}
