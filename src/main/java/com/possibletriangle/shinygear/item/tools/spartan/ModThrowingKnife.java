...
public class ModThrowingKnife extends ItemThrowingKnife implements IModItem {

	private static final String tool = "throwing_knife";
	...
	public ModThrowingKnife(String prefix, ToolMaterial mat, String oreMaterial) {
	...
	public void recipe() {
		new RecipeHandler.ShapedRecipe(new ItemStack(this, 1),
				new Object[] { "yx", 'x', oreMaterial, 'y', new ItemStack(ItemRegistrySW.material, 1, 0) });
	}
