...
public class ModLongsword extends ItemLongsword implements IModItem {

	private static final String tool = "longsword";
	...
	public ModLongsword(String prefix, ToolMaterial material, String oreMaterial) {
		super(prefix + "_" + tool, ShinyGear.MODID, IModSpartanItem.fromMaterial(material, oreMaterial), IModSpartanItem.getDamage(9, material));
	...
	public void recipe() {
		new RecipeHandler.ShapedRecipe(new ItemStack(this, 1),
				new Object[] { " x ", " x ", "xyx", 'x', oreMaterial, 'y', new ItemStack(ItemRegistrySW.material, 1, 0) });
	}
